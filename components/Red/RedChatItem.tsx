...
const RedChatItem = ({ name, img, isSelected }: ItemProps) => {
    return (
        <div className={`flex m-1 justify-between items-center p-3 ${isSelected && "bg-gray-200"} hover:bg-gray-100 rounded-lg relative`}>
